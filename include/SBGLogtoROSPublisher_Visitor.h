...
public:
    ...
    _DECL_OPERATOR_VISITOR(sbg_driver::SbgLogEvent);
    ...
    _DECL_OPERATOR_VISITOR(sbg_driver::SbgLogGpsHdt);
    _DECL_OPERATOR_VISITOR(sbg_driver::SbgLogGpsVel);
    ...
    _DECL_OPERATOR_VISITOR(sbg_driver::SbgLogGpsRaw);
